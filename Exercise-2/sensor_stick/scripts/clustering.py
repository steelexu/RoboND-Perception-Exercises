...
def pcl_callback(pcl_msg):
    ...
    #pcloud_rgbd=ros_to_pcl(pcl_msg)
    pcloud=ros_to_pcl(pcl_msg)
    #pcloud=XYZRGB_to_XYZ(pcloud_rgbd)
    ...
    # TODO: Convert PCL data to R(neocomplcache_start_auto_complete)
    ros_cloud_objects = pcl_to_ros(extractedoutliers)
